...
def init_logger(logger_name):
    if logger_name not in Logger.manager.loggerDict:
        ...
        # handler all
        handler1 = TimedRotatingFileHandler('/Users/xa2/wx_env/web_wx/core/log/all.log', when='D', interval=1, backupCount=7)
        handler1.setFormatter(formatter)
        handler1.setLevel(logging.DEBUG)
        logger1.addHandler(handler1)
        # handler error
        handler2 = TimedRotatingFileHandler('/Users/xa2/wx_env/web_wx/core/log/error.log', when='D', interval=1, backupCount=7)
